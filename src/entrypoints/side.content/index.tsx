  ...
  async main(ctx) {
    ...
    const ui = await createShadowRootUi(ctx, {
      ...
      onMount: (container, shadow, shadowHost) => {
        ...
        const cleanupMirroredStyles = mirrorDynamicStyles("#_goober", shadow)
        // mirrorDynamicStyles(
        //   "style[type='text/css']",
        //   shadow,
        ...
        const cleanupProtectedStyles = protectInternalStyles()
        ...
        return { cleanupMirroredStyles, cleanupProtectedStyles, root, wrapper }
      },
      onRemove: (elements) => {
        elements?.cleanupMirroredStyles()
        elements?.cleanupProtectedStyles()
