...
<h1>乔木沉浸式翻译 / Qiaomu English Learn</h1>

<p>
本仓库是 <a href="https://github.com/mengxi-ream/read-frog">Read Frog</a> 的乔木英语学习 fork/skin，重点加入词汇辅助学习，同时保留原有网页翻译、划词翻译、字幕翻译、TTS、服务商和配置能力。
</p>
